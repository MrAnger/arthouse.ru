            ...
            <div class="col-md-8">
                <div class="blog-entry">
                    ...
                    <div class="prev-next-navigation">
						...
						<?php if($prev): ?>
                            <div class="pull-left">
								<?= Html::a('<< Предыдущая работа', \common\helpers\TheaterHelper::getTheaterFrontendUrl($prev)) ?>
                            </div>
						<?php endif; ?>

						<?php if($next): ?>
                            <div class="pull-right">
								<?= Html::a('Следующая работа >>', \common\helpers\TheaterHelper::getTheaterFrontendUrl($next)) ?>
                            </div>
						<?php endif; ?>
                    </div>
                </div>
