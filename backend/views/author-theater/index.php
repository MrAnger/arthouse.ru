 ...
 * @var \backend\models\TheaterSearch $searchModel
 */

$this->title = 'Театр - ' . $author->user->displayName;
			...
			<?= \yii\grid\GridView::widget([
				...
				'columns'      => [
					[
						'attribute' => 'name',
						'format'    => 'html',
						'value'     => function (\common\models\Theater $model) {
					...
					[
						...
						'format'    => 'raw',
						'value'     => function (\common\models\Theater $model) {
							$url = \common\helpers\TheaterHelper::getTheaterFrontendUrl($model);
